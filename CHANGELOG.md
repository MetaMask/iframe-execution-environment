...
## [0.0.4]
### Uncategorized
- Remove stream name override for metamask provider ([#17](https://github.com/MetaMask/iframe-execution-environment/pull/17))
...
- Added link to instructions to try it out ([#14](https://github.com/MetaMask/iframe-execution-environment/pull/14))
...
[Unreleased]: https://github.com/MetaMask/iframe-execution-environment/compare/v0.0.4...HEAD
